...
public interface ParksApi {
    ...
    default ResponseEntity<List<ParkDto>> parksGet(@NotNull @ApiParam(value = "Filter to specify the visual area on the map", required = true) @Valid AreaFilterDto filter) {
    ...
    default ResponseEntity<Void> parksParkIdDelete(@ApiParam(value = "Numeric ID of the park",required=true) @PathVariable("parkId") Long parkId) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<List<ReviewDto>> parksParkIdReviewsGet(@ApiParam(value = "Numeric ID of the park",required=true) @PathVariable("parkId") Long parkId) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Void> parksParkIdReviewsPost(@ApiParam(value = "Numeric ID of the park",required=true) @PathVariable("parkId") Long parkId,@ApiParam(value = "Review object that needs to be created" ,required=true )  @Valid @RequestBody ReviewDto reviewDto) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> parksPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody ParkDto parkDto) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
