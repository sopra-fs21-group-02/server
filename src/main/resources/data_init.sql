...
-- Create Path
INSERT INTO SOPRAFS21.PATHS(ID,ROUTE,DISTANCE,CREATOR_ID)
VALUES (1,'LINESTRING(8.451911 47.371412, 8.457969 47.364950)',1.0,1);
INSERT INTO SOPRAFS21.PATHS(ID,ROUTE,DISTANCE,CREATOR_ID)
VALUES (2,'LINESTRING(8.561912 48.371413, 8.457968 47.364951)',1.1,1);
INSERT INTO SOPRAFS21.PATHS(ID,ROUTE,DISTANCE,CREATOR_ID)
VALUES (3,'LINESTRING(8.571912 48.381413, 8.457968 47.364951)',1.2,3);
INSERT INTO SOPRAFS21.PATHS(ID,ROUTE,DISTANCE,CREATOR_ID)
VALUES (4,'LINESTRING(8.451912 47.371413, 8.451922 47.371422,  8.457968 47.364951)',1.3,3);